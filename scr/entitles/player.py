...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        # 实例化健康值组件
        self.health = health.Health(self, 50, 20, 5)

        # 初始动作状态（待机）
        self.state = IdleState(self, 'R')
        # 记录上一帧朝向
        self.last_facing = 'R'
    ...
    def judge_state(self, events):
        ...
        # 判断是否移动
        is_moving = (keys[pygame.K_a] and not keys[pygame.K_d]) or (keys[pygame.K_d] and not keys[pygame.K_a])
        # 切换奔跑状态
