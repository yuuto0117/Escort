...
class Player2(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        # 加载图片、初始状态
        self.image = pygame.image.load('assets/images/Player/P2/STAND.png').convert_alpha()
        # 获取位置
...
class IdleState(State):
    def __init__(self, player,  facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/IDLE.png').convert_alpha()
...
class WalkState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/WALK.png').convert_alpha()
        self.animation = animation.Animation(None, self.image, 8, self.facing)
...
class JumpState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/JUMP.png').convert_alpha()
...
class RunState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/RUN.png').convert_alpha()
...
class Attack1State(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/ATTACK1.png').convert_alpha()
...
class Attack2State(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/ATTACK2.png').convert_alpha()
        self.animation = animation.Animation(None, self.image, 5, self.facing, loop=False)
...
class DefendState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/DEFEND.png').convert_alpha()
...
class DodgeState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/DODGE.png').convert_alpha()
...
class HurtState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/HURT.png').convert_alpha()
...
class DeathState(State):
    def __init__(self, player, facing):
        ...
        self.image = pygame.image.load('assets/images/Player/P2/DIE.png').convert_alpha()
